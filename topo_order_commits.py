...
def topo_order_commits():
  ...
  for i in range(0, len(branch_names)):  # get rid of file path and store just names of branches
    position = branch_names[i].find("/.git/refs/heads/") + 17
    branch_names[i] = branch_names[i][position:] # characters in directory string from "position" to the end
